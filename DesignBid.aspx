<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesignBid.aspx.cs" Inherits="ExpansiveNDB.DesignBud" %>
  ...
  <nav class="navbar navbar-collapse navbar-inverse">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlProtectedContent" runat="server">
            <div>
                    <asp:Button ID="btnCreateBid" runat="server" Height="66px" OnClick="btnCreateBid_Click" Text="Create New Bid" Width="174px" />
                    <br />
                    <br />
                    <asp:ListBox ID="lbDesignBidList" runat="server" Height="123px" Width="319px"></asp:ListBox>
                    <br />
                    <br />
                    <asp:Button ID="btnDesignEdit" runat="server" OnClick="btnDesignEdit_Click" Text="Edit" />
            &nbsp;<asp:Button ID="btnDesignDelete" runat="server" Text="Delete" />
            </div>
        </asp:Panel>
    </form>
</body>
